  ...
  return (
    <main className="relative mx-auto max-w-md px-5 pb-28 pt-8">
      ...
      {postAbierto && (
        ...
        >
          <div
            className="sheet mx-auto mt-12 max-w-md rounded-t-[28px] bg-bg pb-28"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="relative">
              {postAbierto.imagen && (
                // eslint-disable-next-line @next/next/no-img-element
                <img src={postAbierto.imagen} alt={postAbierto.titulo} className="max-h-96 w-full rounded-t-[28px] object-cover" />
              )}
              <button
                onClick={() => setPostAbierto(null)}
      ...
      {tableroAbierto && (
        <div className="overlay fixed inset-0 z-[60] overflow-y-auto bg-ink/50 backdrop-blur-sm" onClick={() => setTableroAbierto(null)}>
          <div className="sheet mx-auto mt-14 min-h-[60vh] max-w-md rounded-t-[28px] bg-bg px-5 pb-28 pt-6" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-start justify-between gap-3">
              <div>
